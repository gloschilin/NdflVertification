...
{
    public class Sv1217Validator : BaseReportStepValidator<EsssReports>
    {
        public Sv1217Validator(IValidationResultHandler validationResultHandler, IReportQuarterHelper<EsssReports> reportQuarterHelper) : base(validationResultHandler, reportQuarterHelper)
        {
        }

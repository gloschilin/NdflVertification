...
{
    public class Esss4Uploader : BaseFileUploader<Файл>
    {
    ...
    public class Esss3Uploader : BaseFileUploader<Файл>
    {
    ...
    public class Esss2Uploader : BaseFileUploader<Файл>
    {
    ...
    public class Esss1Uploader : BaseFileUploader<Файл>
    {
